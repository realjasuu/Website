...
UPLOAD_FOLDER = '/path/to/uploaded/images'  # Set the path to the folder where images are uploaded
ALLOWED_EXTENSIONS = {'png', 'jpg', 'jpeg', 'gif'}  # Define the allowed image file extensions
